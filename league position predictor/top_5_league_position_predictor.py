# -*- coding: utf-8 -*-
"""Top 5 league position predictorn.ipynb
...
ml_set = merged_seasons.drop(['league', 'season', 'team', 'Playing Time_MP', 'Playing Time_Starts', 'Playing Time_Min', 'Playing Time_90s', 'url_', 'Squad', 'MP', 'W', 'D', 'L', 'GF', 'xG', 'Top Team Scorer', 'Attendance', 'Pts/MP', 'xGD/90'], axis=1)

ml_set.info()

X = ml_set.loc[:, ml_set.columns != 'Rk']
y = ml_set['Rk']
...
inference_set = merged_1819.drop(['league', 'season_x', 'season_y', 'team', 'Playing Time_MP', 'Playing Time_Starts', 'Playing Time_Min', 'Playing Time_90s', 'url_', 'Squad', 'MP', 'W', 'D', 'L', 'GF', 'xG', 'Top Team Scorer', 'Attendance', 'Pts/MP', 'xGD/90'], axis=1)

X_inference = inference_set.loc[:, inference_set.columns != 'Rk']
y_inference = inference_set['Rk']
